...
<div class="container col-6">
  <form action="patient_view_report.php" method="post">
  ...
  <image src ="images\default_medium_avatar-57d58da4fc778fbd688dcbc4cbc47e14ac79839a9801187e42a796cbd6569847.png" width="10%" height="10%" class="center"></br>
    ...
    <input type="text" id="p_name" name="p_name" readonly value="<?php echo $row;   ?>" required>

    
    
    <input type="submit" name="submit" id="submit" value="View My Reports">
  </form>
...
echo "<tr><th>Patient Name</th><th>Category</th><th>Uploaded on</th><th>File</th></tr>";

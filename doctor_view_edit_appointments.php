...
<div class="container col-6">
  <form action="doctor_view_edit_appointments.php" method="post">
  ...
  <image src ="images\default_medium_avatar-57d58da4fc778fbd688dcbc4cbc47e14ac79839a9801187e42a796cbd6569847.png" width="10%" height="10%" class="center"></br>
    ...
    <input type="text" id="d_name" readonly name="d_name" required value="<?php echo "Dr.".$row;   ?>">

    
    
    <input type="submit" name="submit1" id="submit1" value="View Appointments">
...
echo "<tr><th>Date</th><th>Time</th><th>Cancel Appointment</th></tr>";
...
while($row=mysqli_fetch_array($sqldata,MYSQLI_ASSOC)){
	...
	echo "</td>";
	echo "<td>";
	echo "<a style='text-decoration:none;'href='doctor_delete.php?id={$row["Appointment_id"]}'>Delete </a>";
	echo "</td>";
	echo "</tr>";

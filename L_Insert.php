...
<div class="container col-6">
  <form action="L_Insert.php" method="post">
  </br>
...
<?php
	if(isset($_POST["submit"])){
		...
		$password=$_POST["psw"];
		$sql="INSERT INTO lab_assistant (First_Name,Last_Name,Address,Phone_No,Email,Username,Password) VALUES ('$firstname','$lastname','$address','$phone','$email','$username','$password')";

...
input[type=text], input[type=password] ,input[type=textarea],input[type=tel],input[type=email],input[type=time],input[type=file]{
    width: 35%;
    padding: 12px 15px;
    margin: 8px 0;
    display: block;
...
<?php
	if(isset($_POST["submit"])){
		...
		$sql1="INSERT INTO doctor (First_Name,Last_Name,Category,Phone_No,Address,Email,AvailableDay,StartTime,EndTime,Username,Password) VALUES ('$firstname','$lastname','$category','$phone','$address','$email','$b','$stime','$etime','$username','$password')";

...
$targetDir = "C:\wamp\www\Hospital_Web\upload\ ";
...
$row1=mysqli_query($db,"SELECT Email FROM patient where Patient_id='".$pid."'");
...
if(isset($_POST["submit"]) && !empty($_FILES["file"]["name"])){
    ...
    if(in_array($fileType,$allowTypes)){
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"],$targetFilePath)){
            ...
            $insert = $db->query("INSERT into reports(Patient_id,Doctor_id,Lab_Assistant_id,Category,file_name,uploaded_on) VALUES ('".$pid."','".$did."','".$labid."','".$category."','".$fileName."', NOW())");
            if($insert){
                $statusMsg = "The file ".$fileName. " has been uploaded successfully.";
            
            }else{
                $statusMsg = "File upload to Database failed, please try again.";
            } 
        }else{
...
$mail1->Subject = "Report Details";
$mail1->Body="Your Report Details:<br><br>
                   Dear Patient ,
                   Your report is uploaded on our website!! You can check it!!!";
...
if($mail1->Send()){
    ...
    echo "<script type='text/javascript'>alert('Mail is successfully sent!!!');</script>";
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="upload.php" method="post" enctype="multipart/form-data" id="frm">
    <div class="imgcontainer">
      ...
      <img src="sentreport.png" alt="Avatar" class="avatar">
    </div>

...
<body>
	...
	if(isset($_SESSION['Labassistant_id'])){
		...
		echo "<a href='Labassisstant_change_profile.php'><p id='name'>Ms.".$row."</p></a>";
	}
...
<button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Sent reports</button><br>
<a href="Labassisstant_change_profile.php"><button  style="width:auto;">My profile</button></a></a>

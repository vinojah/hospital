...
<br></br>	
<br>		
<a href="Book.php"> <button  class="button" type="submit" class="btn btn-info" style="border-radius: 10px 10px 10px 10px;">Channelling for Doctor</button></a>  </br> 
 <br></br>
 <a href="patient_view_edit_appointment.php"> <button  class="button" type="submit" class="btn btn-info" style="border-radius: 10px 10px 10px 10px;">View Appointments</button></a>  </br> 
 <br></br>
 <br></br>
   <a href="patient_view_report.php"><button   class="button" type="submit" class="btn btn-info" style="border-radius: 10px 10px 10px 10px;">View Reports/ Test Results</button></a>
	</fieldset>
	</form>
</div>

<div class="img col-7">
<img src="images\90164823-health-insurance-concept-doctor-in-hospital-with-health-insurance-related-icons-in-modern-graphic-in.jpg" style="height:300px;width:500px">
</div>
	</div>

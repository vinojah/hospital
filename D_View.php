...
<div class="col-sm-6">
						<form action="D_View.php" method="POST"> 
								<div class="col-sm-4" >
									<input style="border-color:grey;" class="form-control"  name="keyname" type="text" placeholder="Specification" id="specification">
									...
									<tr>
										...
										<?php 
											if(isset($_POST["submit"])) {
												...
												$sql = "SELECT * FROM doctor WHERE  Category LIKE '%{$_POST["keyname"]}%'";
											...
											if ($result->num_rows>0 ) {
											  ...
											  while($row = $result->fetch_assoc()) {
													...
													echo "<tr>";
														  ...
														  echo "<td>";echo "<a style='text-decoration:none;'href='admin_delete.php?id={$row["Doctor_id"]}'>Delete </a>";
	echo "</td>";
														  echo "</tr>";
														}
											}

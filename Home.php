...
<body>
	...
	<div class="a col-10">
		...
		<div class="b col-2">
		<p><a href="Login.php" style="font-family:Agency FB;font-size:30px;"><image src="images/login-icon-png-20.png" width="40%" height="40%"></br><a href="Login.php" style="font-family:Agency FB;font-size:30px;"> LogIn</a></p>
		</div>
	</div>

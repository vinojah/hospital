...
input[type=password],select,input[type=submit]{
    width: 100%;
    padding: 12px;
...
<div class="container col-6">
  <form action="labassistant_password.php" method="post" name="chngpwd" onSubmit="return valid();">
  ...
  $npass=$_POST["npass"];
  $cfpass=$_POST["cfpass"];
  $sql="UPDATE lab_assistant SET Password='$npass' where Labassistant_id='$Labassistant_id'";
